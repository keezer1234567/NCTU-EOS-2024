...
static ssize_t etx_write(struct file *filp, const char __user *buf, size_t len, loff_t *off)
{
	...
	if(rec_buf[0] == '0' && rec_buf[1] == '0' && rec_buf[2] == '0' && rec_buf[3] == '1')
	{
		gpio_set_value(GPIO_12, 0);
		gpio_set_value(GPIO_16, 0);
		gpio_set_value(GPIO_20, 0);
	...
	if(rec_buf[0] == '0' && rec_buf[1] == '0' && rec_buf[2] == '1' && rec_buf[3] == '0')
	{
		gpio_set_value(GPIO_12, 0);
		gpio_set_value(GPIO_16, 0);
	...
	if(rec_buf[0] == '0' && rec_buf[1] == '1' && rec_buf[2] == '0' && rec_buf[3] == '0')
	{
		gpio_set_value(GPIO_12, 0);
	...
	if(rec_buf[0] == '1' && rec_buf[1] == '0' && rec_buf[2] == '0' && rec_buf[3] == '0')
	{
	...
	if(rec_buf[0] == '1' && rec_buf[1] == '0' && rec_buf[2] == '0' && rec_buf[3] == '1')
	{
		gpio_set_value(GPIO_12, 1);
		gpio_set_value(GPIO_16, 0);
		gpio_set_value(GPIO_20, 0);
	...
	if(rec_buf[0] == '1' && rec_buf[1] == '0' && rec_buf[2] == '1' && rec_buf[3] == '0')
	{
		gpio_set_value(GPIO_12, 1);
		gpio_set_value(GPIO_16, 0);
		gpio_set_value(GPIO_20, 1);
	...
	if(rec_buf[0] == '1' && rec_buf[1] == '1' && rec_buf[2] == '0' && rec_buf[3] == '0')
	{
		gpio_set_value(GPIO_12, 1);
		gpio_set_value(GPIO_16, 1);
		gpio_set_value(GPIO_20, 0);
