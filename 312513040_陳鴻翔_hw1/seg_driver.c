...
{	
    ...
    int index = rec_buf[0];
	data = seg_for_c[index];

	if(data == 0b01111110) // '0' 的七段顯示器編碼
	{
...
MODULE_DESCRIPTION("EOS HW1 seg_driver");